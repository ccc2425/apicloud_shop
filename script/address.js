...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
  ...
  {
   //if(cmbProvince.options[cmbProvince.selectedIndex].value === '未选择')return;
...
{name:'平顶山市', areaList:['新华区','卫东区','石龙区','湛河区','宝丰县','叶　县','鲁山县','郏　县','舞钢市','汝州市']},
...
{name:'汕尾市', areaList:['城　区','海丰县','陆河县','陆丰市']},
